...
LABEL maintainer="jared <lijie1@weiboyi.com>" \
      php="7.4.3"
...
#ENV PHP_URL="http://www.php.net/get/php-7.4.3.tar.xz/from/this/mirror" PHP_ASC_URL="http://www.php.net/get/php-7.4.3.tar.xz.asc/from/this/mirror"
